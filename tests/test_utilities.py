...
import fan.globals
from fan.utilities import conditional_download, detect_fps, extract_frames, create_temp, get_temp_directory_path, clear_temp


@pytest.fixture(scope = 'module', autouse = True)
def before_all() -> None:
	fan.globals.temp_frame_quality = 100
	fan.globals.trim_frame_start = None
	fan.globals.trim_frame_end = None
	fan.globals.temp_frame_format = 'png'
	conditional_download('.assets/examples',
	[
		'https://github.com/fan/fan-assets/releases/download/examples/target-240p.mp4'
	])
...
def before_each() -> None:
	fan.globals.trim_frame_start = None
	fan.globals.trim_frame_end = None
	fan.globals.temp_frame_quality = 90
	fan.globals.temp_frame_format = 'jpg'
...
def test_extract_frames_with_trim_start() -> None:
	fan.globals.trim_frame_start = 224
	data_provider =\
	[
...
def test_extract_frames_with_trim_start_and_trim_end() -> None:
	fan.globals.trim_frame_start = 124
	fan.globals.trim_frame_end = 224
	data_provider =\
	[
...
def test_extract_frames_with_trim_end() -> None:
	fan.globals.trim_frame_end = 100
	data_provider =\
	[
		('.assets/examples/target-240p-25fps.mp4', 120),
		('.assets/examples/target-240p-30fps.mp4', 100),
