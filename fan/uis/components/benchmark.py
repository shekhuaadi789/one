...
from fan.face_analyser import get_face_analyser
from fan.face_store import clear_static_faces
...
from fan.filesystem import clear_temp
...
def start(benchmark_runs : List[str], benchmark_cycles : int) -> Generator[List[Any], None, None]:
	fan.globals.source_paths = [ '.assets/examples/source.jpg' ]
...
def benchmark(target_path : str, benchmark_cycles : int) -> List[Any]:
	...
	for i in range(benchmark_cycles):
		fan.globals.target_path = target_path
		fan.globals.output_path = normalize_output_path(fan.globals.source_paths, fan.globals.target_path, tempfile.gettempdir())
