...
from fan.processors.frame.typings import FaceSwapperModel, FaceEnhancerModel, FrameEnhancerModel, FaceDebuggerItem
...
def render() -> None:
	...
	FACE_SWAPPER_MODEL_DROPDOWN = gradio.Dropdown(
		...
		visible = 'face_swapper' in fan.globals.frame_processors
	)
	FACE_ENHANCER_MODEL_DROPDOWN = gradio.Dropdown(
		...
		visible = 'face_enhancer' in fan.globals.frame_processors
	)
	...
	FRAME_ENHANCER_MODEL_DROPDOWN = gradio.Dropdown(
		...
		visible = 'frame_enhancer' in fan.globals.frame_processors
	)
	...
	FACE_DEBUGGER_ITEMS_CHECKBOX_GROUP = gradio.CheckboxGroup(
		...
		visible = 'face_debugger' in fan.globals.frame_processors
	)
